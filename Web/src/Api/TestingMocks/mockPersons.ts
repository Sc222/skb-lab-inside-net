...
export const MockPersons: Map<string, PersonModel> = new Map<string, PersonModel>([
    [
        "33bc751f-a56b-4704-bfb6-03239f04dcfc",
        {
            ...
            Telegram: "stacy_tg",
            Slack: "https://companydomain.slack.com/team/U1H63DASZ",
            //SlackId: string,
    ...
    [
        "3f3b75de-efcd-48aa-a59e-e805496467e1",
        {
            ...
            Slack: "https://companydomain.slack.com/team/F1A63DASZ",
            //SlackId: string,
    ...
    [
        "ad59dd3c-bdec-4cc8-bb72-e460479a77e7",
        {
            ...
            Slack: "https://companydomain.slack.com/team/U1G63DAEZ",
            //SlackId: string,
    ...
    [
        "b082dfe1-ab44-4547-9e31-0237e9e32eb4",
        {
            ...
            Telegram: "andrew",
            Slack: "https://companydomain.slack.com/team/G3E63DASZ",
            //SlackId: string,
    ...
    [
        "0a3bba87-2322-493f-995c-f5f560d9f49b",
        {
            ...
            Telegram: "vitek",
            Slack: "https://companydomain.slack.com/team/U1F23SASZ",
            //SlackId: string,
    ...
    [
        "419c3781-75ad-4792-9ad1-da30021bcbe7",
        {
            ...
            Telegram: "rus_tut",
            Slack: "https://companydomain.slack.com/team/Q5H63DAFZ",
            //SlackId: string,
    ...
    [
        "1d5aee70-b83a-4f11-a744-993b8b3bfc26",
        {
            ...
            Slack: "https://companydomain.slack.com/team/A5V63DAS3",
            //SlackId: string,
