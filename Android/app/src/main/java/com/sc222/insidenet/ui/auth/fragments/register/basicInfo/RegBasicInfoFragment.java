...
public class RegBasicInfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<String> positions = Arrays.asList("Стажер Web-разработчик", "Стажер-разработчик", "Стажер Android-разработчик", "Стажер-тестировщик", "Стажер-аналитик", "Cтажер HR-специалист");
